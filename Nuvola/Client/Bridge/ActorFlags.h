...
static inline ActorFlags operator|(ActorFlags lhs, ActorFlags rhs) {
	return static_cast<ActorFlags>(static_cast<int>(lhs) | static_cast<int>(rhs));
}

static inline ActorFlags& operator|=(ActorFlags& lhs, ActorFlags rhs) {
	lhs = static_cast<ActorFlags>(static_cast<int>(lhs) | static_cast<int>(rhs));
	return lhs;
}
